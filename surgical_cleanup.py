...
# find index for line 784 (0-indexed 783)
...
# find where it ends, which is just before {/* LOJISTA - CARTÃO NOVO DETECTADO */}
end_tag = "{mode === 'LOJISTA_CARD_PROMPT'"
end_index = -1
...
# The new cleaned up Lojista Actions block + linkVip logic
# Note: I need to make sure I don't miss the linkVip button (deviceUid logic)
...
print("Successfully surgical cleanup of PublicTerminal.tsx")
