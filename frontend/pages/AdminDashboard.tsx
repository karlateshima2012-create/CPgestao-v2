...
import { Users, AlertTriangle, Plus, Search, Edit2, Lock, Trash2, X, CheckCircle, CheckCircle2, Check, Copy, Calendar, RefreshCw, Save, ArrowUpCircle, Tag as TagIcon, Shield, Download, Crown, Smartphone, Monitor } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-fade-in">
          <Card className="w-full max-w-2xl p-0 shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <div className="p-6 space-y-8 overflow-y-auto flex-1">
              ...
              {/* SESSÃO CONDICIONAL: CARTÕES OU TOTENS */}
              <hr className="border-gray-100 dark:border-gray-800" />
